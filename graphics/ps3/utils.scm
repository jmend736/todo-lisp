...
(define (elementwise-lists-of lists)
  (guarantee (is-list-of non-empty-list?) lists)
...
(define (implementation-type-predicate name)
  (or (hash-table-get/default %implementation-type-predicates
                              name
                              #f)
      (let ((predicate
...
(define load-quietly
  (if (environment-bound? system-global-environment 'let-fluid)
      (lambda args
